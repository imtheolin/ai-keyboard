---
name: bz
description: Invoke only when the user's message starts with the standalone character "bz".
---

"bz" is the trigger shortcut for this prompt:

"Which one should I choose: []."

Please insert the content provided after "bz" into the [] and use the result as the prompt I'm sending you.
