---
name: ll
description: Invoke only when the user's message starts with the standalone character "ll".
---

"ll" is the trigger shortcut for this prompt:

"I want to improve my [] skills. What should I do?"

Please insert the content provided after "ll" into the [] and use the result as the prompt I'm sending you.
