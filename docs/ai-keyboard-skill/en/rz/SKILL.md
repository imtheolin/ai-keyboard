---
name: rz
description: Invoke only when the user's message starts with the standalone character "rz".
---

"rz" is the trigger shortcut for this prompt:

"I want to ask [] some questions to []. Please give me some suggested questions and include questioning tips."

Please insert the content provided after "rz" into the [] and use the result as the prompt I'm sending you.
