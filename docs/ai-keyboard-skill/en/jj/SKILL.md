---
name: jj
description: Invoke only when the user's message starts with the standalone character "jj".
---

"jj" is the trigger shortcut for this prompt:

"Provide a sharp and incisive evaluation of the following: []."

Please insert the content provided after "jj" into the [] and use the result as the prompt I'm sending you.
