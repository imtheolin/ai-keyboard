---
name: gz
description: Invoke only when the user's message starts with the standalone character "gz".
---

"gz" is the trigger shortcut for this prompt:

"When I want [], what might I really want?"

Please insert the content provided after "gz" into the [] and use the result as the prompt I'm sending you.
