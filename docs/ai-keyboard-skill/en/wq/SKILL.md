---
name: wq
description: Invoke only when the user's message starts with the standalone character "wq".
---

"wq" is the trigger shortcut for this prompt:

"Use the 5 Whys method to identify the root cause of []."

Please insert the content provided after "wq" into the [] and use the result as the prompt I'm sending you.
