---
name: w1
description: Invoke only when the user's message starts with the standalone character "w1".
---

"w1" is the trigger shortcut for this prompt:

"Use first principles to explain why []."

Please insert the content provided after "w1" into the [] and use the result as the prompt I'm sending you.
