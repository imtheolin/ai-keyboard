---
name: dd
description: Invoke only when the user's message starts with the standalone character "dd".
---

"dd" is the trigger shortcut for this prompt:

"Define [] in professional terms."

Please insert the content provided after "dd" into the [] and use the result as the prompt I'm sending you.
