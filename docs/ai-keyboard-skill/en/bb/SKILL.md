---
name: bb
description: Invoke only when the user's message starts with the standalone character "bb".
---

"bb" is the trigger shortcut for this prompt:

"Give me a "What Not to Do" guide when buying or choosing []."

Please insert the content provided after "bb" into the [] and use the result as the prompt I'm sending you.
