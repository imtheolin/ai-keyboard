---
name: mq
description: Invoke only when the user's message starts with the standalone character "mq".
---

"mq" is the trigger shortcut for this prompt:

"Generate a travel guide for []."

Please insert the content provided after "mq" into the [] and use the result as the prompt I'm sending you.
