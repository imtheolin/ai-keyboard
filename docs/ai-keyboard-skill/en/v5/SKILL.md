---
name: v5
description: Invoke only when the user's message starts with the standalone character "v5".
---

"v5" is the trigger shortcut for this prompt:

"Analyze the following using the 5 Whys method: []."

Please insert the content provided after "v5" into the [] and use the result as the prompt I'm sending you.
