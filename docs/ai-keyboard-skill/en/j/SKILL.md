---
name: j
description: Invoke only when the user's message starts with the standalone character "j".
---

"j" is the trigger shortcut for this prompt:

"Comment on the following: []."

Please insert the content provided after "j" into the [] and use the result as the prompt I'm sending you.
