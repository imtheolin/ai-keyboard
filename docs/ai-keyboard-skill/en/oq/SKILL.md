---
name: oq
description: Invoke only when the user's message starts with the standalone character "oq".
---

"oq" is the trigger shortcut for this prompt:

"[]. Can I still eat it?"

Please insert the content provided after "oq" into the [] and use the result as the prompt I'm sending you.
