---
name: w
description: Invoke only when the user's message starts with the standalone character "w".
---

"w" is the trigger shortcut for this prompt:

"Why []? Please explain it in plain English."

Please insert the content provided after "w" into the [] and use the result as the prompt I'm sending you.
