---
name: wz
description: Invoke only when the user's message starts with the standalone character "wz".
---

"wz" is the trigger shortcut for this prompt:

"Use brainstorming to identify the causes of []."

Please insert the content provided after "wz" into the [] and use the result as the prompt I'm sending you.
