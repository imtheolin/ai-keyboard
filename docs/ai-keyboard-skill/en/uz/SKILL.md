---
name: uz
description: Invoke only when the user's message starts with the standalone character "uz".
---

"uz" is the trigger shortcut for this prompt:

"I feel mentally exhausted because []. What should I do?"

Please insert the content provided after "uz" into the [] and use the result as the prompt I'm sending you.
