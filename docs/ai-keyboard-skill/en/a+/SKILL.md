---
name: a+
description: Invoke only when the user's message starts with the standalone character "a+".
---

"a+" is the trigger shortcut for this prompt:

"Rewrite, more comprehensive and detailed: []."

Please insert the content provided after "a+" into the [] and use the result as the prompt I'm sending you.
