---
name: vv
description: Invoke only when the user's message starts with the standalone character "vv".
---

"vv" is the trigger shortcut for this prompt:

"Analyze the following problem from multiple perspectives: []."

Please insert the content provided after "vv" into the [] and use the result as the prompt I'm sending you.
