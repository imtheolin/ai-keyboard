---
name: dz
description: Invoke only when the user's message starts with the standalone character "dz".
---

"dz" is the trigger shortcut for this prompt:

"What is the difference between []?"

Please insert the content provided after "dz" into the [] and use the result as the prompt I'm sending you.
