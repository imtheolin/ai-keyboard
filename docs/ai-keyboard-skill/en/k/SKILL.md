---
name: k
description: Invoke only when the user's message starts with the standalone character "k".
---

"k" is the trigger shortcut for this prompt:

"Recommend some [], along with the reasons for your recommendations."

Please insert the content provided after "k" into the [] and use the result as the prompt I'm sending you.
