---
name: v6
description: Invoke only when the user's message starts with the standalone character "v6".
---

"v6" is the trigger shortcut for this prompt:

"Analyze the following using the Six Thinking Hats method: []."

Please insert the content provided after "v6" into the [] and use the result as the prompt I'm sending you.
