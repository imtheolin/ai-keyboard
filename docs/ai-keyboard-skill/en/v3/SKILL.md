---
name: v3
description: Invoke only when the user's message starts with the standalone character "v3".
---

"v3" is the trigger shortcut for this prompt:

"Analyze the following using the syllogistic method: []."

Please insert the content provided after "v3" into the [] and use the result as the prompt I'm sending you.
