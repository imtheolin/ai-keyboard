---
name: az
description: Invoke only when the user's message starts with the standalone character "az".
---

"az" is the trigger shortcut for this prompt:

"Rewrite, making it simpler and easier to understand: []."

Please insert the content provided after "az" into the [] and use the result as the prompt I'm sending you.
