---
name: xx
description: Invoke only when the user's message starts with the standalone character "xx".
---

"xx" is the trigger shortcut for this prompt:

"Provide reference templates for [], along with examples."

Please insert the content provided after "xx" into the [] and use the result as the prompt I'm sending you.
