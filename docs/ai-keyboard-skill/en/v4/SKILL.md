---
name: v4
description: Invoke only when the user's message starts with the standalone character "v4".
---

"v4" is the trigger shortcut for this prompt:

"Analyze the following using the four-quadrant principle: []."

Please insert the content provided after "v4" into the [] and use the result as the prompt I'm sending you.
