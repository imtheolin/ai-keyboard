---
name: v2
description: Invoke only when the user's message starts with the standalone character "v2".
---

"v2" is the trigger shortcut for this prompt:

"Analyze the following using the 80/20 rule: []."

Please insert the content provided after "v2" into the [] and use the result as the prompt I'm sending you.
