---
name: xq
description: Invoke only when the user's message starts with the standalone character "xq".
---

"xq" is the trigger shortcut for this prompt:

"Give me some writing materials about []."

Please insert the content provided after "xq" into the [] and use the result as the prompt I'm sending you.
