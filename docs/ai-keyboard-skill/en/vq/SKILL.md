---
name: vq
description: Invoke only when the user's message starts with the standalone character "vq".
---

"vq" is the trigger shortcut for this prompt:

"Analyze the pros and cons of the following: []."

Please insert the content provided after "vq" into the [] and use the result as the prompt I'm sending you.
