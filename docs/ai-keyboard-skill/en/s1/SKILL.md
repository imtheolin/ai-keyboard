---
name: s1
description: Invoke only when the user's message starts with the standalone character "s1".
---

"s1" is the trigger shortcut for this prompt:

"Analyze and appreciate the following: []."

Please insert the content provided after "s1" into the [] and use the result as the prompt I'm sending you.
