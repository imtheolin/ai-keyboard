---
name: a2
description: Invoke only when the user's message starts with the standalone character "a2".
---

"a2" is the trigger shortcut for this prompt:

"Rewrite, more engaging: []."

Please insert the content provided after "a2" into the [] and use the result as the prompt I'm sending you.
