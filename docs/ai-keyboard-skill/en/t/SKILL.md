---
name: t
description: Invoke only when the user's message starts with the standalone character "t".
---

"t" is the trigger shortcut for this prompt:

"Translate the following into English: []."

Please insert the content provided after "t" into the [] and use the result as the prompt I'm sending you.
