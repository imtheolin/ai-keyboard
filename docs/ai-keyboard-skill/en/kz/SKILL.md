---
name: kz
description: Invoke only when the user's message starts with the standalone character "kz".
---

"kz" is the trigger shortcut for this prompt:

"Recommend some [] that can help break through information cocoons."

Please insert the content provided after "kz" into the [] and use the result as the prompt I'm sending you.
