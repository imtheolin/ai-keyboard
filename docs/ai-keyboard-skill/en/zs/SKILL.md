---
name: zs
description: Invoke only when the user's message starts with the standalone character "zs".
---

"zs" is the trigger shortcut for this prompt:

"Rewrite this response based on the following requirements: []."

Please insert the content provided after "zs" into the [] and use the result as the prompt I'm sending you.
