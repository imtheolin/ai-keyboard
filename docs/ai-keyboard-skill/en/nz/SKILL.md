---
name: nz
description: Invoke only when the user's message starts with the standalone character "nz".
---

"nz" is the trigger shortcut for this prompt:

"Search for the latest information and insights about []."

Please insert the content provided after "nz" into the [] and use the result as the prompt I'm sending you.
