---
name: tq
description: Invoke only when the user's message starts with the standalone character "tq".
---

"tq" is the trigger shortcut for this prompt:

"Analyze the subtext or implications of the following: []."

Please insert the content provided after "tq" into the [] and use the result as the prompt I'm sending you.
