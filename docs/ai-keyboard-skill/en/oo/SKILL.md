---
name: oo
description: Invoke only when the user's message starts with the standalone character "oo".
---

"oo" is the trigger shortcut for this prompt:

"Is it better to consume [] before or after meals?"

Please insert the content provided after "oo" into the [] and use the result as the prompt I'm sending you.
