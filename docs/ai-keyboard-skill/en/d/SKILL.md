---
name: d
description: Invoke only when the user's message starts with the standalone character "d".
---

"d" is the trigger shortcut for this prompt:

"What is []？Define in plain English."

Please insert the content provided after "d" into the [] and use the result as the prompt I'm sending you.
