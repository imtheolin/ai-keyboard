---
name: ss
description: Invoke only when the user's message starts with the standalone character "ss".
---

"ss" is the trigger shortcut for this prompt:

"Conduct a close reading of the following: []."

Please insert the content provided after "ss" into the [] and use the result as the prompt I'm sending you.
