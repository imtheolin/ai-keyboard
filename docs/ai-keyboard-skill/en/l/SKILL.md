---
name: l
description: Invoke only when the user's message starts with the standalone character "l".
---

"l" is the trigger shortcut for this prompt:

"How to learn [] quickly."

Please insert the content provided after "l" into the [] and use the result as the prompt I'm sending you.
