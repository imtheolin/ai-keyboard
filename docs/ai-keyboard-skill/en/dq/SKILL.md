---
name: dq
description: Invoke only when the user's message starts with the standalone character "dq".
---

"dq" is the trigger shortcut for this prompt:

"Write a research report on []."

Please insert the content provided after "dq" into the [] and use the result as the prompt I'm sending you.
