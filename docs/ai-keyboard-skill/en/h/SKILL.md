---
name: h
description: Invoke only when the user's message starts with the standalone character "h".
---

"h" is the trigger shortcut for this prompt:

"I want to []. What should I do?"

Please insert the content provided after "h" into the [] and use the result as the prompt I'm sending you.
