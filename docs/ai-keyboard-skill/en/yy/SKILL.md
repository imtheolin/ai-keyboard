---
name: yy
description: Invoke only when the user's message starts with the standalone character "yy".
---

"yy" is the trigger shortcut for this prompt:

"Provide teaching methods for the following instructional content: []. The target audience is []."

Please insert the content provided after "yy" into the [] and use the result as the prompt I'm sending you.
