---
name: eq
description: Invoke only when the user's message starts with the standalone character "eq".
---

"eq" is the trigger shortcut for this prompt:

"[], which phrasing is better? Please give me a few more options."

Please insert the content provided after "eq" into the [] and use the result as the prompt I'm sending you.
