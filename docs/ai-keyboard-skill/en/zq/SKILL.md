---
name: zq
description: Invoke only when the user's message starts with the standalone character "zq".
---

"zq" is the trigger shortcut for this prompt:

"Reanswer this question based on the following requirements: []."

Please insert the content provided after "zq" into the [] and use the result as the prompt I'm sending you.
