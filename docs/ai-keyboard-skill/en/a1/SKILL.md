---
name: a1
description: Invoke only when the user's message starts with the standalone character "a1".
---

"a1" is the trigger shortcut for this prompt:

"Rewrite, more penetrating: []."

Please insert the content provided after "a1" into the [] and use the result as the prompt I'm sending you.
