---
name: s
description: Invoke only when the user's message starts with the standalone character "s".
---

"s" is the trigger shortcut for this prompt:

"Generate a summary of the following: []."

Please insert the content provided after "s" into the [] and use the result as the prompt I'm sending you.
