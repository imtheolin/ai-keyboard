---
name: qz
description: Invoke only when the user's message starts with the standalone character "qz".
---

"qz" is the trigger shortcut for this prompt:

"Improve this prompt, then execute it: []."

Please insert the content provided after "qz" into the [] and use the result as the prompt I'm sending you.
