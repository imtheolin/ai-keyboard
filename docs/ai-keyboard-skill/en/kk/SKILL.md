---
name: kk
description: Invoke only when the user's message starts with the standalone character "kk".
---

"kk" is the trigger shortcut for this prompt:

"Recommend some [], the requirements are as follows: []."

Please insert the content provided after "kk" into the [] and use the result as the prompt I'm sending you.
