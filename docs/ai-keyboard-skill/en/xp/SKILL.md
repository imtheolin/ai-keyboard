---
name: xp
description: Invoke only when the user's message starts with the standalone character "xp".
---

"xp" is the trigger shortcut for this prompt:

"I want to write []. Please help spark my writing ideas."

Please insert the content provided after "xp" into the [] and use the result as the prompt I'm sending you.
