---
name: jq
description: Invoke only when the user's message starts with the standalone character "jq".
---

"jq" is the trigger shortcut for this prompt:

"My goals are as follows: []. Please directly point out the shortcomings of the following and provide suggestions for improvement: []."

Please insert the content provided after "jq" into the [] and use the result as the prompt I'm sending you.
