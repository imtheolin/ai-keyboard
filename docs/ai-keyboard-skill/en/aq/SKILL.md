---
name: aq
description: Invoke only when the user's message starts with the standalone character "aq".
---

"aq" is the trigger shortcut for this prompt:

"Rewrite, using five different rhetorical devices: []."

Please insert the content provided after "aq" into the [] and use the result as the prompt I'm sending you.
