---
name: vz
description: Invoke only when the user's message starts with the standalone character "vz".
---

"vz" is the trigger shortcut for this prompt:

"Analyze the underlying logic of the following: []."

Please insert the content provided after "vz" into the [] and use the result as the prompt I'm sending you.
