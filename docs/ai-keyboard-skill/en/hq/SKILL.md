---
name: hq
description: Invoke only when the user's message starts with the standalone character "hq".
---

"hq" is the trigger shortcut for this prompt:

"Give me a "What Not to Do" guide to []."

Please insert the content provided after "hq" into the [] and use the result as the prompt I'm sending you.
